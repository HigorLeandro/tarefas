...
class AddTarefasAFazer extends Component {
    ...
    _salvarTarefasAFazer(){
        if( !this.props.desc.trim()){
            ...
            this.props.salvarTarefasEmAndamento({ desc, obs, nome, prioritaria}); 
            this.props.onSave()
        }
...
export default connect(mapStateToProps, { modificaDesc ,modificaObs, salvarTarefasEmAndamento,modificaPrioridade })(AddTarefasAFazer)