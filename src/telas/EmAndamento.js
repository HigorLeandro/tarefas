...
class Inicio extends Component {
    ...
    _concluitarefa (uid, desc, obs, usuario, momemntInicial, tarefaPrioritaria,grauDaTarefa) {
        const IdTarefa = uid;
        const descTarefa = desc;
        const obsTarefa = obs;
        const userTarefa = usuario;
        const dataTarefa = momemntInicial;
...
export default connect(mapStateToProps, {tarefasUsuarioFetchEmAndamento,ExcluirTarefaEmAndamento, concluiTarefa,modificaUID})(Inicio)
