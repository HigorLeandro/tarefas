...
class ModalExcluirTarefaConcluida extends Component {
...
export default connect(mapStateToProps, { modificaDesc ,modificaObs, salvarTarefasEmAndamento,modificaPrioridade,ExcluirTarefaConcluida })(ModalExcluirTarefaConcluida)