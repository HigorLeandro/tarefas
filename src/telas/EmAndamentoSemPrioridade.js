...
class EmAndamentoSemPrioridade extends Component {
...
export default connect(mapStateToProps, {tarefasUsuarioFetchEmAndamento,ExcluirTarefaEmAndamento, concluiTarefa,modificaUID, concluiTarefaReiniciada})(EmAndamentoSemPrioridade)
